                        ...
                        <tbody>
                            ...
                            <tr class="item{{$user->id}}">
                                ...
                                <td>
                                    ...
                                    <input type="button" class="btn btn-info" onclick="location.href='/telegram/dashboard/users/{{$user->id}}/edit'" value="{{trans('app.EditBtn')}}" />
                          
                                    <input type="button" class="btn btn-danger" onclick="deleteUser(this, {{$user->id}});return false;" value="{{trans('app.DeleteBtn')}}" />
                                    @if($user->chat_id != NULL )
                                    <input type="button" class="btn btn-success" onclick="location.href='/telegram/dashboard/users/{{$user->id}}/message'" value="{{trans('app.SendTelegramMessage')}}" />
                                    @endif
